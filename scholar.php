...
<div class="card"style="width: 40%; margin-left:350px; >
    ...
    <div class="card-body px-lg-5 pt-0">
        ...
        <!-- Form -->
        <form class="text-center" style="color: #757575;" action="registerProcess.php" method="POST">
            ...
            <select class="mdb-select" name="select">
                <option value="" disabled>Choose option</option>
                <option value="1" selected>MBA</option>
                <option value="2">BCS</option>
                <option value="3">Free IT</option>
            </select>
             <div class="md-form mt-0">
                <input type="Text" id="materialRegisterFormPercent" class="form-control" name="per">
                <label for="materialRegisterFormPercent">Previous GPA/Percentage</label>
            </div>


            <!-- Group of material radios - option 1 -->
                <div class="form-check">
                  <label for="materialRegisterFormSex">select Gender:</label><br>
                  <input type="radio" class="form-check-input" id="materialGroupExample1" name="gender">
                  <label class="form-check-label" for="materialGroupExample1">Male</label>
                </div>

                <!-- Group of material radios - option 2 -->
                <div class="form-check">
                  <input type="radio" class="form-check-input" id="materialGroupExample2" name="gender" checked>
                  <label class="form-check-label" for="gender">Female</label>
                </div>

                <!-- Group of material radios - option 3 -->
                <div class="form-check">
                  <input type="radio" class="form-check-input" id="materialGroupExample3" name="gender">
                  <label class="form-check-label" for="materialGroupExample3">Others</label>
                </div>
             <!-- Subject -->
            <div class="md-form mt-0">
                <input type="text" id="materialRegisterFormAddress" class="form-control" name="prev">
                <label for="materialRegisterFormEmail">Pervious College</label>
            </div>


            <div class="md-form mt-0">
                <input type="text" id="materialRegisterFormAddress" class="form-control" name="address">
                <label for="materialRegisterFormEmail">Address</label>
            </div>

            <span>Qualification</span>
            <select class="mdb-select" name="qual">
                <option value="" disabled>Choose option</option>
                <option value="1" selected>SLC</option>
            ...
            <!-- Sign up button -->
            <button class="btn btn-outline-info btn-rounded btn-block my-4 waves-effect z-depth-0" type="submit" name="submit">Apply</button>

            <hr>

            <!-- Terms of service -->
            <p>By clicking
                <em>Apply</em> you agree to our

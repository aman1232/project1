...
<div class="card" style="width: 40%; margin-left:350px; ;">
    ...
    <div class="card-body px-lg-5 pt-0">
        ...
        <!-- Form -->
        <form class="text-center" style="color: #757575;" action="contactProcess.php" method="POST">

            <!-- Name -->
            <div class="md-form mt-3">
                <input type="text" id="materialContactFormName" class="form-control" name="fname">
                <label for="materialContactFormName">FirstName</label>
            </div>

            <!-- E-mail -->
            <div class="md-form">
                <input type="text" id="materialContactFormEmail" class="form-control" name="lname">
                <label for="materialContactFormEmail">LastName</label>
            </div>
            <div class="md-form">
            ...
            <!--Message-->
            <div class="md-form">
                <textarea id="materialContactFormMessage" class="form-control md-textarea" rows="3" name="comment"></textarea>
                <label for="materialContactFormMessage">Comment</label>
            </div>
